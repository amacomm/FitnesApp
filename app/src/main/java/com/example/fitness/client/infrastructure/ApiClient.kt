...
open class ApiClient(val baseUrl: String) {
    ...
    public fun addAccessToken(authResponse: AuthResponse){
        if(authResponse.accessToken != null)
            addAccessToken(authResponse.accessToken)
    }

    public fun addAccessToken(accessToken: String){
        defaultHeaders += mapOf("Authorization" to "Bearer $accessToken")
    }
